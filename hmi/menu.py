...
class Menu(QWidget):
    def __init__(self, parent, config):
        ...
        self.adjustSize()
        self.register_target("ZOOM", ZoomProxy())
        # TheMenuObject = self
    ...
    def register_map(self, m):
        self.avmap = m
        self.registered_targets['ZOOM'].register_map (m)
...
class ZoomProxy:
    ...
    def change(self, _):
        ...
        if self.avmap is not None:
            self.avmap.incZoom (diff * 0.1)
        self.last_value = val
